...
import 'package:admin_kg1/preview3.dart';
...
//                                         imageName: '${myController3.text}Type3',
//                                       ),
//                                     ),
//                                   );
...
class type3 extends StatefulWidget {
  ...
  String word;
  bool flag = false;
  type3({key, this.title, this.sub, this.calssName, this.flag})
      : super(key: key);
  type3.fromType3(
      {key,
      this.title,
      ...
      : super(key: key);
  @override
  State<type3> createState() => _MyAppState();
}

class _MyAppState extends State<type3> {
  ...
  Future<void> _save() async {
    ...
    if (!isValid) {
      ...
      if (widget.flag == false) {
        final response = await http.post(Uri.parse('${IP}E_type3'), body: {
          'title': myController1.text,
          "word": myController2.text,
          'dotChar': myController3.text,
          'Answer': myController3.text,
          'nameOfImage': '${myController3.text}Type3',
        ...
        final response = await http.post(Uri.parse('${IP}EditE_type3'), body: {
          'title': myController1.text,
          "word": myController2.text,
          'dotChar': myController3.text,
          'Answer': myController3.text,
        ...
        if (widget.exc_title == myController1.text &&
            ...
            widget.name_of_image == myController3.text + "Type3") {
          Fluttertoast.showToast(
  ...
  sendNotification() {
    String msg = "تمت اضافه التمرين الثالث لحرف ال${myController3.text}";
    print("::::::::::::::::::::::::::::::::::::");
  ...
  Future<String> _uploadImage() async {
    ...
    //String uploadurl = 'http://localhost/flutter_test/uploadImage.php';
    List<int> imageBytes = _image.readAsBytesSync();
    print(_image.path);
    String baseimage = base64Encode(imageBytes);
    String uniqueImageID = '${myController3.text}Type3';
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                                image: DecorationImage(
                                                    image: NetworkImage(
                                                        "http://10.0.2.2/flutter_test/uploads/${'${myController3.text}Type3'}.jpg"),
                                                    fit: BoxFit.cover)),
                                          ),
                                        ],
                                      ),
